"""
There are n cities connected by some number of flights. You are given an array flights where flights[i] = [s, e, price] indicates that there is a flight from city s to city e with cost price.
